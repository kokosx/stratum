...
VALUES
    ...
    (
        ...
        '.stratum-tone-muted{color:#667085}.stratum-tone-accent{color:#175cd3}',
        'core', 1, unixepoch(), unixepoch()
    ),
    (
        ...
        '.stratum-button{display:inline-block;padding:.65rem 1rem;border-radius:.35rem;text-decoration:none}.stratum-button-primary{background:#175cd3;color:#fff}.stratum-button-secondary{border:1px solid currentColor;color:inherit}',
        'core', 1, unixepoch(), unixepoch()
    ),
    (
        ...
        '.stratum-section{margin-inline:auto}.stratum-width-normal{max-width:720px}.stratum-width-wide{max-width:1100px}.stratum-width-full{max-width:none}.stratum-spacing-none{padding-block:0}.stratum-spacing-sm{padding-block:1rem}.stratum-spacing-md{padding-block:2rem}.stratum-spacing-lg{padding-block:4rem}',
        'core', 1, unixepoch(), unixepoch()
    ),
    (
        ...
        '.stratum-stack{display:flex;flex-direction:column}.stratum-gap-none{gap:0}.stratum-gap-sm{gap:.5rem}.stratum-gap-md{gap:1rem}.stratum-gap-lg{gap:2rem}',
        'core', 1, unixepoch(), unixepoch()
    )
