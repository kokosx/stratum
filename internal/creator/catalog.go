...
var creatorCopy = map[string]map[string]string{
	"en": {
		...
		"heading.ready_to_talk":           "Ready to talk?",
		"heading.get_in_touch":            "Get in touch",
		"heading.what_we_do":              "What we do",
		"heading.selected_cases":          "Selected cases",
		"heading.browse_articles":         "Browse articles",
		"heading.services_glance":         "Services at a glance",
		...
		"cta.view_product":                "View product",
		"cta.read_article":                "Read article",
		"cta.read_case_study":             "Read case study",
		...
		"text.home.simple_intro":          "A practical starting point you can shape into anything.",
		"text.home.simple_what":           "Share a concise overview of your work, values and the outcomes you create for clients.",
		"text.home.agency_intro":          "A focused agency that ships useful work — calmly and on time.",
		"text.home.agency_glance":         "Strategy, identity and site builds — delivered as one practical sequence. Details live on the Services page.",
		"text.home.kb_intro":              "Quick answers and in-depth guides for everyday work. Search or browse by topic.",
		"page.about.title":                "About",
		"page.about.body":                 "Use this page to introduce your work, values and approach.",
		"page.contact.title":              "Contact",
		"page.contact.body.portfolio":     "Tell us what you are working on and what kind of help you need.",
		"page.contact.body.product":       "Ask about specifications, availability or a custom requirement.",
		"page.contact.body.simple":        "Tell us what you need and we will get back to you.",
		"page.contact.body.agency":        "Tell us what you are building.",
		"page.contact.body.local":         "Share a few details and we will respond with a practical next step.",
		"page.services.body":              "We help teams clarify, design and ship useful work.",
		"page.services.body.local":        "We help teams clarify, design and ship useful work.",
		"form.project_enquiry":            "Project enquiry",
		"form.request_info":               "Request information",
		"form.contact":                    "Contact",
		"contenttype.service.singular":    "Service",
		"contenttype.service.plural":      "Services",
		"contenttype.project.singular":    "Project",
		"contenttype.project.plural":      "Projects",
		"contenttype.product.singular":    "Product",
		"contenttype.product.plural":      "Products",
		"contenttype.case_study.singular": "Case Study",
		"contenttype.case_study.plural":   "Case Studies",
		"contenttype.article.singular":    "Article",
		"contenttype.article.plural":      "Articles",
	},
	"pl": {
		...
		"heading.ready_to_talk":           "Porozmawiajmy?",
		"heading.get_in_touch":            "Skontaktuj się",
		"heading.what_we_do":              "Czym się zajmujemy",
		"heading.selected_cases":          "Wybrane realizacje",
		"heading.browse_articles":         "Przeglądaj artykuły",
		"heading.services_glance":         "Usługi w skrócie",
		"cta.start_conversation":          "Rozpocznij rozmowę",
		"cta.request_consult":             "Poproś o konsultację",
		"cta.contact_us":                  "Skontaktuj się",
		"cta.get_in_touch":                "Skontaktuj się",
		...
		"cta.view_project":                "Zobacz projekt",
		"cta.view_product":                "Zobacz produkt",
		"cta.read_article":                "Czytaj artykuł",
		"cta.read_case_study":             "Zobacz case study",
		...
		"text.home.simple_intro":          "Praktyczny punkt startu, który dopasujesz do siebie.",
		"text.home.simple_what":           "Opisz zwięźle swoją pracę, wartości i efekty, które tworzysz dla klientów.",
		"text.home.agency_intro":          "Skupiona agencja, która dostarcza użyteczne projekty — spokojnie i na czas.",
		"text.home.agency_glance":         "Strategia, identyfikacja i strony — jako jedna praktyczna całość. Szczegóły na stronie Usługi.",
		"text.home.kb_intro":              "Szybkie odpowiedzi i pogłębione przewodniki do codziennej pracy. Szukaj lub przeglądaj tematy.",
		...
		"page.contact.body.portfolio":     "Opowiedz, nad czym pracujesz i jakiego wsparcia potrzebujesz.",
		"page.contact.body.product":       "Zapytaj o specyfikację, dostępność lub niestandardowe wymagania.",
		"page.contact.body.simple":        "Powiedz nam, czego potrzebujesz, a wkrótce odpowiemy.",
		"page.contact.body.agency":        "Powiedz nam, co budujesz.",
		"page.contact.body.local":         "Podziel się szczegółami, a odpowiemy z praktycznym kolejnym krokiem.",
		"page.services.body":              "Pomagamy zespołom doprecyzować, zaprojektować i dostarczyć użyteczną pracę.",
		"page.services.body.local":        "Pomagamy zespołom doprecyzować, zaprojektować i dostarczyć użyteczną pracę.",
		"form.project_enquiry":            "Zapytanie o projekt",
		"form.request_info":               "Poproś o informacje",
		"form.contact":                    "Kontakt",
		"contenttype.service.singular":    "Usługa",
		"contenttype.service.plural":      "Usługi",
		"contenttype.project.singular":    "Projekt",
		"contenttype.project.plural":      "Projekty",
		"contenttype.product.singular":    "Produkt",
		"contenttype.product.plural":      "Produkty",
		"contenttype.case_study.singular": "Studium przypadku",
		"contenttype.case_study.plural":   "Studia przypadków",
		"contenttype.article.singular":    "Artykuł",
		"contenttype.article.plural":      "Artykuły",
	},
}
...
func localizedServiceEntries(lang string) []entrySpec {
	if lang == "pl" {
		return []entrySpec{
			{Title: "Konsultacja", Slug: "konsultacja", Excerpt: "Skupiona rozmowa, aby zrozumieć pracę i zarekomendować kolejne kroki.", Body: "Przeglądamy potrzeby i proponujemy praktyczną drogę naprzód.", Fields: map[string]any{"short_summary": "Jasna porada i praktyczny kolejny krok.", "service_area": "Okolice i zdalnie"}},
			{Title: "Instalacja", Slug: "instalacja", Excerpt: "Staranna konfiguracja z jasną komunikacją.", Body: "Instalacja planowana wokół Twojej przestrzeni i priorytetów.", Fields: map[string]any{"short_summary": "Staranna konfiguracja od początku do końca.", "service_area": "Okolice"}},
			{Title: "Konserwacja", Slug: "konserwacja", Excerpt: "Regularna opieka.", Body: "Regularna konserwacja pomaga wcześnie wykryć drobne problemy.", Fields: map[string]any{"short_summary": "Regularna opieka dla niezawodnego działania.", "service_area": "Okolice"}},
