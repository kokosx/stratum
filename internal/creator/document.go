...
func homepageTemplate(prefix string, preset PresetID, tagline, formID string) *document.Document {
	...
	switch preset {
	case PresetBlog:
		heroStack := b.stack("vertical", "md", "start", "start", b.entryTitle(1, "lg"))
		if tagline != "" {
			heroStack.Children = append(heroStack.Children, b.lead(tagline))
			// Rebuild heroStack with proper gap md (12-20 title->lead)
			heroStack = b.stack("vertical", "md", "start", "start", b.entryTitle(1, "lg"), b.lead(tagline))
		}
		...
		latestStack := b.stack("vertical", "lg", "stretch", "start", b.heading("Latest posts", 2), b.collection("post", "query", "list", 1, "lg", 5, post))
	...
	case PresetPortfolio:
		...
		return &document.Document{Version: 1, Nodes: []document.Node{
			b.section("wide", "xl", "default", heroStack),
			b.section("wide", "md", "default", b.stack("vertical", "lg", "stretch", "start", b.heading("Selected Work", 2), b.collection("project", "query", "grid", 2, "xl", 6, project))),
			b.node("core/content-slot", 1, nil, nil),
		}}
	case PresetLanding:
		heroStack := b.stack("vertical", "md", "center", "center", b.entryTitleAlign(1, "lg", "center"))
		if tagline != "" {
			heroStack.Children = append(heroStack.Children, b.node("core/text", 2, map[string]any{"text": richText(tagline)}, map[string]any{"align": "center", "tone": "muted", "size": "lg", "maxWidth": "narrow"}))
		}
		heroStack.Children = append(heroStack.Children, b.node("core/button-group", 1, nil, map[string]any{"direction": "horizontal", "gap": "md", "align": "center", "wrap": true}, b.buttonSize("Start a conversation", "#contact", "primary", "lg")))
		...
		return &document.Document{Version: 1, Nodes: []document.Node{
			...
			b.section("wide", "lg", "muted", b.stack("vertical", "lg", "stretch", "start", b.heading("What clients say", 2), b.collection("testimonial", "query", "grid", 2, "lg", 4, testimonial))),
			b.sectionAnchor("content", "lg", "default", "contact", b.stack("vertical", "md", "start", "start", b.heading("Make the next step clear", 2), b.lead("Share what you are trying to achieve. We will respond with a practical next step."), b.node("core/form", 2, nil, map[string]any{"formId": formID}))),
			b.node("core/content-slot", 1, nil, nil),
		}}
	case PresetProducts:
		heroStack := b.stack("vertical", "sm", "start", "start", b.entryTitle(1, "lg"))
		if tagline != "" {
			heroStack = b.stack("vertical", "sm", "start", "start", b.entryTitle(1, "lg"), b.lead(tagline))
		}
		...
		return &document.Document{Version: 1, Nodes: []document.Node{
			...
			b.section("wide", "md", "default", b.stack("vertical", "lg", "stretch", "start", b.heading("Featured Products", 2), b.collection("product", "query", "grid", 3, "lg", 6, product))),
			b.node("core/content-slot", 1, nil, nil),
		}}
	default:
		heroStack := b.stack("vertical", "md", "start", "start", b.entryTitle(1, "lg"))
		...
		heroStack.Children = append(heroStack.Children, b.node("core/button-group", 1, nil, map[string]any{"direction": "horizontal", "gap": "md", "align": "start", "wrap": true}, b.button("Request a consultation", "/contact", "primary")))
		serviceInner := b.stack("vertical", "sm", "start", "start", b.entryTitle(2, "md"), b.entryField("fields.short_summary", "p"), b.entryField("fields.service_area", "span"), b.node("core/entry-link", 1, map[string]any{"text": "Learn more"}, nil))
		...
		return &document.Document{Version: 1, Nodes: []document.Node{
			...
			b.section("wide", "md", "default", b.stack("vertical", "lg", "stretch", "start", b.heading("Services", 2), b.collection("service", "query", "grid", 3, "lg", 5, service))),
			b.section("content", "lg", "primary", b.stack("vertical", "md", "start", "start", b.heading("Need a practical next step?", 2), b.text("Tell us what you need and we will explain how we can help."), b.node("core/button-group", 1, nil, map[string]any{"direction": "horizontal", "gap": "md", "align": "start", "wrap": true}, b.node("core/button", 1, map[string]any{"label": "Contact us", "url": "/contact"}, map[string]any{"variant": "primary", "size": "md", "width": "auto", "align": "left", "openInNewTab": false})))),
			b.node("core/content-slot", 1, nil, nil),
		}}
	}
}
...
func singleTemplate(prefix string, preset PresetID) *document.Document {
		...
		return &document.Document{Version: 1, Nodes: []document.Node{
			b.section("wide", "lg", "default",
				b.stack("vertical", "md", "start", "start",
					...
					b.entryMedia("(min-width: 1200px) 80vw, 100vw"),
				),
			),
			b.node("core/content-slot", 1, nil, nil),
		}}
	case PresetProducts:
		...
		return &document.Document{Version: 1, Nodes: []document.Node{
			b.section("wide", "lg", "default", b.grid(2, "xl", b.entryMedia("(min-width: 900px) 50vw, 100vw"), details)),
			b.node("core/content-slot", 1, nil, nil),
		}}
	default:
		return &document.Document{Version: 1, Nodes: []document.Node{
...
func archiveTemplate(prefix string, preset PresetID) *document.Document {
	...
	case PresetBlog:
		...
		return &document.Document{Version: 1, Nodes: []document.Node{header, b.section("content", "md", "default", b.collection("post", "context", "list", 1, "lg", 20, item))}}
	case PresetPortfolio:
		...
		return &document.Document{Version: 1, Nodes: []document.Node{header, b.section("wide", "md", "default", b.collection("project", "context", "grid", 2, "xl", 20, item))}}
	case PresetProducts:
		...
		return &document.Document{Version: 1, Nodes: []document.Node{header, b.section("wide", "md", "default", b.collection("product", "context", "grid", 3, "lg", 20, item))}}
	default:
		...
		return &document.Document{Version: 1, Nodes: []document.Node{header, b.section("wide", "md", "default", b.collection("service", "context", "grid", 3, "lg", 20, item))}}
	}
}
